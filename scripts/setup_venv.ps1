<#
Bootstrap virtualenv and set PYTHONPATH for this session.
...
# Find a Python launcher/interpreter
$pythonCmd = $null
...
# Set PYTHONPATH to src/main relative to the current working directory
